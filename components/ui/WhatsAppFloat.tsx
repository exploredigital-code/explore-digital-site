      ...
      {visible && (
        ...
        >
          ...
          <a
            ...
            className="relative w-14 h-14 bg-sol rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(226,118,47,0.4)] hover:bg-sol-forte hover:scale-110 active:scale-95 transition-all duration-200"
            aria-label={t('whatsapp_aria')}
          >
            {/* Ping animation */}
            <span className="absolute inset-0 rounded-full bg-sol animate-ping opacity-20" />
            <svg width="26" height="26" viewBox="0 0 24 24" fill="#1B3025">
