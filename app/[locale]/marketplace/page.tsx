            ...
            <div className="mt-8 mb-16">
              <AnimateIn className="mb-10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h2 className="text-[clamp(22px,3vw,32px)] font-bold text-g-dark tracking-tight">{t('individual_title')}</h2>
                </div>
                <p className="text-[15px] text-g-dark/55 mt-2 max-w-[480px]">{t('individual_desc')}</p>
                <div className="h-px bg-g-dark/10 mt-4" />
              </AnimateIn>
          ...
          <AnimateIn>
            <div className="rounded-2xl bg-g-dark p-10 lg:p-14 text-center relative overflow-hidden mt-4">
              ...
              <div className="relative z-10">
                <div className="text-[11px] font-bold tracking-[0.2em] uppercase text-g-light/40 mb-4">{t('cta_eyebrow')}</div>
