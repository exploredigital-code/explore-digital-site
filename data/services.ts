    ...
    subServices: [
      {
        ...
        grupo: 'presenca',
        prazoDias: [10, 15],
        tagline: 'Uma página, uma oferta, uma temporada.',
        description: 'Landing page é peça de campanha. Existe para uma oferta, uma temporada ou uma data, e tudo nela empurra para uma única ação. Se o que você procura é presença permanente, o produto é o website institucional: a landing não substitui a casa, ela trabalha uma campanha por vez.',
        forWhom: ['Pacote de temporada, feriado ou data específica', 'Campanha de tráfego pago que precisa de destino próprio', 'Lançamento de uma experiência ou de um espaço novo'],
        features: [
          'Uma página, com uma única ação',
          'Domínio incluso por 1 ano',
          'Hospedagem inclusa',
          'SEO e geolocalização configurados',
          'Segurança configurada',
          'Estudo do negócio antes de qualquer desenho',
          'Desenvolvida para o seu público-alvo',
          '30 dias de suporte grátis',
        ],
        result: 'Uma página de campanha no ar, com destino próprio para o seu tráfego',
      },
      {
        ...
        features: [
          ...
          'SEO e geolocalização configurados',
          'Estudo do negócio antes de qualquer desenho',
          'Site feito para o seu público, não template',
          'Caminho de reserva até o motor ou o WhatsApp',
          '5 rodadas de ajuste',
          '30 dias de suporte grátis',
        ],
