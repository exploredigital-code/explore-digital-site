...
const content: Record<string, LocaleContent> = {
  pt: {
    ...
    subServices: {
      ...
      'landing-page': {
        ...
        features: ['Uma página, com uma única ação', 'Domínio incluso por 1 ano', 'Hospedagem inclusa', 'SEO e geolocalização configurados', 'Segurança configurada', 'Estudo do negócio antes de qualquer desenho', 'Desenvolvida para o seu público-alvo', '30 dias de suporte grátis'],
  ...
  en: {
    ...
    subServices: {
      ...
      'landing-page': {
        name: 'Landing Page',
        tagline: 'One page, one offer, one season.',
        description: 'A landing page is a campaign piece. It exists for one offer, one season or one date, and everything on it pushes toward a single action. If what you are after is permanent presence, the product is the institutional website: a landing page does not replace the house, it works one campaign at a time.',
        forWhom: ['A season package, a holiday or a specific date', 'A paid traffic campaign that needs its own destination', 'The launch of a new experience or a new space'],
        features: ['One page, with a single action', 'Domain included for 1 year', 'Hosting included', 'SEO and geolocation configured', 'Security configured', 'A study of the business before anything is designed', 'Built for your target audience', '30 days of free support'],
        result: 'A campaign page live, with its own destination for your traffic',
      },
      'website-institucional': {
  ...
  es: {
    ...
    subServices: {
      ...
      'landing-page': {
        name: 'Landing Page',
        tagline: 'Una página, una oferta, una temporada.',
        description: 'La landing page es una pieza de campaña. Existe para una oferta, una temporada o una fecha, y todo en ella empuja hacia una única acción. Si lo que buscas es presencia permanente, el producto es el sitio institucional: la landing no reemplaza la casa, trabaja una campaña por vez.',
        forWhom: ['Paquete de temporada, feriado o fecha específica', 'Campaña de tráfico pago que necesita destino propio', 'Lanzamiento de una experiencia o de un espacio nuevo'],
        features: ['Una página, con una única acción', 'Dominio incluido por 1 año', 'Hosting incluido', 'SEO y geolocalización configurados', 'Seguridad configurada', 'Estudio del negocio antes de cualquier diseño', 'Desarrollada para tu público objetivo', '30 días de soporte gratis'],
        result: 'Una página de campaña en el aire, con destino propio para tu tráfico',
      },
      'website-institucional': {
